...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        test_acc1 = sess.run(accuracy, feed_dict={ x_flat: mnist.test.images[:5000], d: mnist.test.labels[:5000] })
        test_acc2 = sess.run(accuracy, feed_dict={ x_flat: mnist.test.images[5000:], d: mnist.test.labels[5000:] })
